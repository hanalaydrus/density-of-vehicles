build:
	...
	g++ -std=c++11 `pkg-config --cflags protobuf grpc` -c -o main.o main.cc
	g++ -std=c++11 `pkg-config --cflags protobuf grpc opencv` -c -o Density.o Density.cc
	g++ -std=c++11 `pkg-config --cflags opencv` -c -o IPM.o IPM.cc
	g++ -std=c++11 -c -o Model.o Model.cc
	g++ densityContract.pb.o densityContract.grpc.pb.o main.o Density.o IPM.o Model.o -lmysqlcppconn -lcurl `pkg-config --libs protobuf grpc++ grpc opencv` -ldl -o main
...
build_db_image:
	docker build -t asia.gcr.io/tugas-akhir-hana/db-density:latest ./mariadb/
...
push_gcp_image:
	docker push asia.gcr.io/tugas-akhir-hana/db-density:latest
